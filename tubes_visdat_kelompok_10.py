...
plot = figure(plot_width = 1100, 
             ...
             title="COVID 19 DATA IN INDONESIA PERIOD 2020-2021")
...
def renew_plot_data(attr, old, new):
...
dPicker.on_change('value', renew_plot_data)
...
select.on_change('value', renew_plot_data)
